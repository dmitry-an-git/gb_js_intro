...
let tempCentrigrade = 25;
let tempFahrenheit = (9 / 5) * tempCentrigrade + 32;
console.log(`${tempCentrigrade} degrees centrigrade is ${tempFahrenheit} degrees Fahrenheit`);
...
let name = "dima";
let admin = name;
console.log(`The value of 'admin' variable is ${admin}`);